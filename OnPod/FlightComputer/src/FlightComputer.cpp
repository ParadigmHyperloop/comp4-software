...
int main(int32_t argc, char **argv) {
    ...
    sPodNetworkValues.iNodeTimeoutMili = 5000;
    sPodNetworkValues.iBrakeNodeServerPortNumber = 5000; // Port # to receive UDP from Nodes

    sPodNetworkValues.iCommaderTimeoutMili = 20000; // Timeout for heartbeat to Control Interface
