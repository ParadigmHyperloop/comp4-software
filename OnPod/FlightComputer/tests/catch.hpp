...
struct SourceLineInfo {
  ...
  SourceLineInfo(char const* _file, std::size_t _line) noexcept : file(_file),
                                                                  line(_line) {}
...
class StringRef {
 ...
 public:  // construction/ assignment
  ...
  StringRef(StringRef const& other) noexcept : m_start(other.m_start),
                                               m_size(other.m_size) {}

  StringRef(StringRef&& other) noexcept : m_start(other.m_start),
                                          m_size(other.m_size),
                                          m_data(other.m_data) {
  ...
  StringRef(char const* rawChars, size_type size) noexcept : m_start(rawChars),
                                                             m_size(size) {}

  StringRef(std::string const& stdString) noexcept : m_start(stdString.c_str()),
...
#define CATCH_INTERNAL_ERROR(msg)                                             \
  Catch::throw_exception(CATCH_PREPARE_EXCEPTION(                             \
      std::logic_error, CATCH_INTERNAL_LINEINFO << ": Internal Catch error: " \
                                                << msg))
