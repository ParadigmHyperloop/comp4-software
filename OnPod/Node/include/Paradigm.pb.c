...
/* Generated by nanopb-0.3.9.3 at Wed Apr 17 16:40:21 2019. */
...
const pb_field_t DtsNodeToFc_fields[7] = {
    ...
    PB_FIELD(  4, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, pressureTemperature, rotorTemperature, 0),
    PB_FIELD(  5, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, highPressure, pressureTemperature, 0),
    PB_FIELD(  6, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, lowPressure, highPressure, 0),
    PB_LAST_FIELD
};
