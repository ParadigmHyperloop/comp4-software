...
const pb_field_t RearNodeToFc_fields[6] = {
    PB_FIELD(  1, FLOAT   , REQUIRED, STATIC  , FIRST, RearNodeToFc, tubePressure, tubePressure, &RearNodeToFc_tubePressure_default),
    PB_FIELD(  2, FLOAT   , REQUIRED, STATIC  , OTHER, RearNodeToFc, coolantPressure1, tubePressure, &RearNodeToFc_coolantPressure1_default),
    PB_FIELD(  3, FLOAT   , REQUIRED, STATIC  , OTHER, RearNodeToFc, coolantPressure2, coolantPressure1, &RearNodeToFc_coolantPressure2_default),
    PB_FIELD(  4, FLOAT   , REQUIRED, STATIC  , OTHER, RearNodeToFc, coolantPressure3, coolantPressure2, &RearNodeToFc_coolantPressure3_default),
    PB_FIELD(  5, FLOAT   , REQUIRED, STATIC  , OTHER, RearNodeToFc, coolantTemperature, coolantPressure3, &RearNodeToFc_coolantTemperature_default),
    PB_LAST_FIELD
};
