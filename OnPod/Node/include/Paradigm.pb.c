...
const BrakeNodeStates DtsNodeToFc_brakeNodeState_default = BrakeNodeStates_bnsFlight;
...
const pb_field_t DtsNodeToFc_fields[8] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, DtsNodeToFc, brakeNodeState, brakeNodeState, &DtsNodeToFc_brakeNodeState_default),
