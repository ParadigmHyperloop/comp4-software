...
const dtsFcToNode_nodeState dtsFcToNode_state_default = dtsFcToNode_nodeState_STANDBY;
...
const pb_field_t dtsFcToNode_fields[2] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, dtsFcToNode, state, state, &dtsFcToNode_state_default),
    PB_LAST_FIELD
};

const pb_field_t dtsNodeToFc_fields[4] = {
