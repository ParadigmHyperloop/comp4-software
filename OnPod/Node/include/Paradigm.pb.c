...
/* Generated by nanopb-0.3.9.3 at Thu Apr 25 19:36:04 2019. */
...
const pb_field_t DtsNodeToFc_fields[8] = {
    PB_FIELD(  1, UENUM   , OPTIONAL, STATIC  , FIRST, DtsNodeToFc, brakeNodeState, brakeNodeState, 0),
    PB_FIELD(  2, BOOL    , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, brakeSolenoidState, brakeNodeState, &DtsNodeToFc_brakeSolenoidState_default),
    PB_FIELD(  3, BOOL    , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, ventSolenoidState, brakeSolenoidState, &DtsNodeToFc_ventSolenoidState_default),
    PB_FIELD(  4, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, rotorTemperature, ventSolenoidState, 0),
    PB_FIELD(  5, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, pneumaticTemperature, rotorTemperature, 0),
    PB_FIELD(  6, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, tankPressure, pneumaticTemperature, 0),
    PB_FIELD(  7, FLOAT   , OPTIONAL, STATIC  , OTHER, DtsNodeToFc, brakePressure, tankPressure, 0),
    PB_LAST_FIELD
};
