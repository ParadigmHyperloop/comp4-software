...
/* Generated by nanopb-0.3.9.3 at Wed May  8 18:11:51 2019. */
...
const pb_field_t SimpleMessage_fields[5] = {
    PB_FIELD(  1, INT32   , REQUIRED, STATIC  , FIRST, SimpleMessage, lucky_number, lucky_number, 0),
    PB_FIELD(  2, FLOAT   , REQUIRED, STATIC  , OTHER, SimpleMessage, lucky_float, lucky_number, 0),
    PB_FIELD(  3, BOOL    , REQUIRED, STATIC  , OTHER, SimpleMessage, lucky_bool, lucky_float, 0),
    PB_FIELD(  4, FLOAT   , REQUIRED, STATIC  , OTHER, SimpleMessage, lucky_float2, lucky_bool, 0),
    PB_LAST_FIELD
};
...
const pb_field_t FcToBrakeNode_fields[8] = {
    ...
    PB_FIELD(  3, BOOL    , OPTIONAL, STATIC  , OTHER, FcToBrakeNode, hpSolenoidState, manualNodeState, 0),
    PB_FIELD(  4, BOOL    , OPTIONAL, STATIC  , OTHER, FcToBrakeNode, ventSolenoidState, hpSolenoidState, 0),
    PB_FIELD(  5, BOOL    , OPTIONAL, STATIC  , OTHER, FcToBrakeNode, lpSolenoid1State, ventSolenoidState, 0),
    PB_FIELD(  6, BOOL    , OPTIONAL, STATIC  , OTHER, FcToBrakeNode, lpSolenoid2State, lpSolenoid1State, 0),
    PB_FIELD(  7, BOOL    , OPTIONAL, STATIC  , OTHER, FcToBrakeNode, lpSolenoid3State, lpSolenoid2State, 0),
    PB_LAST_FIELD
};

const pb_field_t DtsNodeToFc_fields[8] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, DtsNodeToFc, brakeNodeState, brakeNodeState, &DtsNodeToFc_brakeNodeState_default),
    PB_FIELD(  2, BOOL    , REQUIRED, STATIC  , OTHER, DtsNodeToFc, brakeSolenoidState, brakeNodeState, &DtsNodeToFc_brakeSolenoidState_default),
    PB_FIELD(  3, BOOL    , REQUIRED, STATIC  , OTHER, DtsNodeToFc, ventSolenoidState, brakeSolenoidState, &DtsNodeToFc_ventSolenoidState_default),
    PB_FIELD(  4, FLOAT   , REQUIRED, STATIC  , OTHER, DtsNodeToFc, rotorTemperature, ventSolenoidState, &DtsNodeToFc_rotorTemperature_default),
    PB_FIELD(  5, FLOAT   , REQUIRED, STATIC  , OTHER, DtsNodeToFc, pneumaticTemperature, rotorTemperature, &DtsNodeToFc_pneumaticTemperature_default),
    PB_FIELD(  6, FLOAT   , REQUIRED, STATIC  , OTHER, DtsNodeToFc, tankPressure, pneumaticTemperature, &DtsNodeToFc_tankPressure_default),
    PB_FIELD(  7, FLOAT   , REQUIRED, STATIC  , OTHER, DtsNodeToFc, brakePressure, tankPressure, &DtsNodeToFc_brakePressure_default),
    PB_LAST_FIELD
};
