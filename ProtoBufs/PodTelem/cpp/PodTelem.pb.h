...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_PodTelem_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_PodTelem_2eproto {
...
class telemetry :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pds.telemetry) */ {
 public:
  telemetry();
  virtual ~telemetry();
 ...
 private:
  ...
  friend struct ::TableStruct_PodTelem_2eproto;
};
// ===================================================================
