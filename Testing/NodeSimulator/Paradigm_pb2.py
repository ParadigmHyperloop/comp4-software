...
_BRAKENODEDATA_BREAKNODESTATE = _descriptor.EnumDescriptor(
  name='breakNodeState',
  full_name='brakeNodeData.breakNodeState',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
